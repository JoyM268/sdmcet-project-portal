<?php
    ...
    if($asc == "true"){
        $sql = "SELECT Title, Link, Email, MemberNames, Semester, Description FROM ProjectList ORDER BY Title";
    }else{
        $sql = "SELECT Title, Link, Email, MemberNames, Semester, Description FROM ProjectList ORDER BY Title DESC";
    }
